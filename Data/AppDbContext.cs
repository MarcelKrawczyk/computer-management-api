...
public class AppDbContext : DbContext
{
    ...
    private static void SeedData(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Component>().HasData(
            ...
            new Component { Code = "SSD0000001", Name = "Samsung 990 Pro 1TB", Description = "NVMe SSD 1TB Gen4", ComponentManufacturersId = 4, ComponentTypesId = 4 }
        );
        ...
        modelBuilder.Entity<PC>().HasData(
            ...
            new PC { Id = 3, Name = "Workstation Ultra", Weight = 18.0f, Warranty = 48, CreatedAt = new DateTime(2026, 3, 20, 10, 0, 0), Stock = 3 }
        );
